...
STORAGE_PREFIX = "peds_pretest3_20260525_full_v2"
LOCK_LINE = "3주차 Pretest Anki · 2026 최신복기/야마/2023 PDF 반영 · uncertain은 원문확인 표시"
...
<div class="peds3-scaffold-note" style="margin:12px 0 18px;padding:14px 16px;border:1px solid rgba(221,214,254,.55);background:rgba(248,250,252,.92);border-radius:16px;box-shadow:0 12px 30px rgba(15,23,42,.16);">
  <div style="font-size:13px;font-weight:950;color:#4c1d95;margin-bottom:6px;">소아청소년과 3주차 Pretest Anki v2</div>
  <div style="font-size:13px;line-height:1.6;color:#334155;">공식 범위는 <strong>16~28장</strong>입니다. 현재 카드 <strong>{source_count}</strong>개를 최신 2026 복기, 25-21 야마/source layout, 2023 PDF audit 기준으로 묶었습니다. <strong>원문 확인</strong> 표시는 답 고정 금지 카드입니다.</div>
