...
def card_data(source):
    ...
    for c in source:
        ...
        cards.append({'id': c['id'], 'num': c['num'], 'q': q, 'a': c['answerHtml'], 'g': guide})
    return cards
...
def decorate(text):
    ...
    text = replace_once(text, '<div class="card-grid">', '''<div class="deck-note">56개 주제별 문제 · 기존 Anki SRS<br><small>정답 공개 → 🔴 1분 · 🟠 5분 · 🟢 10분/숙달 · 🔵 내일<br>전체 다시 풀기는 학습 기록만 초기화하며 수정 답안·필기는 남습니다.</small></div>
<div class="card-grid">''')
